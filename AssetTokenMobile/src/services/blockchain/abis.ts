/**
 * CONTRACT ABIs
 * Smart contract ABIs for ethers.js integration
 */
...
export const AssetRegistryABI = [
  ...
  'function getAsset(uint256 assetId) external view returns (tuple(address token, address owner, string metadataURI, bool active))',
  'function getAssetIdByToken(address token) external view returns (uint256)',
  'function assets(uint256) view returns (address token, address owner, string metadataURI, bool active)',
  'function tokenToAssetId(address) view returns (uint256)',
